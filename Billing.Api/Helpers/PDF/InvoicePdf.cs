...
namespace Billing.Api.Helpers.PDF
{
    public class InvoicePdf : BasicPdf
    {
        ...
        protected override void CreatePage()
        {
            ...
            //string imageFilePath = System.Web.HttpContext.Current.Server.MapPath("~/Billing.Web/images/slika.png");
            //row.Cells[1].AddImage(imageFilePath);
            ...
            //Image image = section.Headers.Primary.AddImage("../../../Billing.Web/images/slika.png");
            //image.Height = "2.5cm";
            //image.Width = "3.5cm";

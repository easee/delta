...
{
    [TestClass]
    public class TestSalesByProduct
    {
        SalesByProductController controller = new SalesByProductController();
        HttpConfiguration config = new HttpConfiguration();
        HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, "api/salesbyproduct");
        ...
        [TestMethod]
        public void SalesByProductGoodDate()
        {
            Initializing();
            GetReady();
        ...
        [TestMethod]
        public void SalesByProductBadDate()
        {
            Initializing();
            GetReady();
            var actRes = controller.Post(new RequestModel()
        ...
        [TestMethod]
        public void SalesByProductContent()
        {
            Initializing();
            GetReady();
            var actRes = controller.Post(new RequestModel()

...
namespace Billing.Tests.ReportTests
{
    ...
    public class TestSalesByCategory
    {
        ...
        HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, "api/salesbycategory");
        ...
        [TestMethod]
        public void SalesByCategoryGoodDate()
        {
            Initializing();
            GetReady();
        ...
        [TestMethod]
        public void SalesByCategoryBadDate()
        {
            Initializing();
            GetReady();
            var actRes = controller.Post(new RequestModel()
        ...
        [TestMethod]
        public void SalesByCategoryContent()
        {
            Initializing();
            GetReady();
            var actRes = controller.Post(new RequestModel()
